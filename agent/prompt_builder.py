...
PLATFORM_HINTS = {
    ...
    "feishu": (
        ...
        "Write back only after the exact confirmation text '确认修改 CHANGE_ID'; vague replies "
        "like '同意', '可以', or direct-change requests must not bypass preview confirmation. "
        "You can send media files natively: include MEDIA:/absolute/path/to/file "
